...
var Dropzone = function (props) {
    ...
    var _v = React__namespace.useState(false), isDragging = _v[0], setIsDragging = _v[1];
    //state for checking upload start
    var _w = React__namespace.useState(false), isUploading = _w[0], setIsUploading = _w[1];
    //state for message on footer
    var _x = React__namespace.useState(""), localMessage = _x[0], setLocalMessage = _x[1];
...
var FileInputButton = function (props) {
    ...
    var inputRef = React__namespace.useRef(null);
    //state for checking upload start
    var _j = React__namespace.useState(false), isUploading = _j[0], setIsUploading = _j[1];
    //Id for uploding through FuiFileManager
